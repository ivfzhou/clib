...
int main(void) {
    ...
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [2]
    puts("");

    elem = 1;
    assert(!doubleLinkedList_lpush(list, &elem));
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [1, 2]
    puts("");

    elem = 3;
    assert(!doubleLinkedList_rpush(list, &elem));
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [1, 2, 3]
    puts("");

    assert(!doubleLinkedList_travel(list, _intVisitor));
    ...
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [4, 2, 3]
    puts("");
    ...
    elem = 3;
    assert(!doubleLinkedList_locate(list, _intCmp, &elem, &index));
    assert(index == 2);

    elem = 4;
    assert(!doubleLinkedList_getSet(list, index, &elem));
    assert(elem == 3);
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [4, 2, 4]
    puts("");

    assert(!doubleLinkedList_getDel(list, index, &elem));
    assert(elem == 4);
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // [4, 2]
    puts("");
    ...
    assert(elem == 2);
    doubleLinkedList_fprint(list, stdout, _intToString, 1); // []
    puts("");
    ...
    assert(!doubleLinkedList_free(list));
